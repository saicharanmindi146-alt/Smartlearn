        ...
        <div className="lg:col-span-2 rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between">
          <div>
            ...
            {lastViewed ? (
              ...
              <>
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold uppercase">
                    Class 10 CBSE · Mathematics
                  </span>
                </div>
                <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">
                  Class 10 NCERT Mathematics: All 14 Chapters &amp; Exercise Solutions
                </h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                  Chapter notes, key formulas, step-by-step exercise answers, and appendices A1 &amp; A2 aligned with the latest CBSE syllabus.
                </p>
              </>
            )}
            ...
            <div className="mt-5 space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold">
                ...
                <span className="text-blue-600 dark:text-blue-400">14 Chapters Ready</span>
              </div>
              <div className="w-full h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-500 via-blue-600 to-indigo-600 rounded-full w-[70%]" />
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 mt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
            <span className="text-xs text-slate-500">
              {academicProfile ? `${academicProfile.classLevel} · ${academicProfile.board}` : 'Grade 10 · CBSE Syllabus'}
            </span>
            <Link
              href={lastViewed ? `/student/courses/${lastViewed.resourceId}` : '/student/courses/sub-class10-math'}
            ...
            >
              ...
              <span>Explore Math &amp; Solutions &rarr;</span>
            </Link>
          </div>
        </div>
